    ...
    <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="bg-gray-900 rounded-lg shadow p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-2xl font-bold text-gray-200">{vehicles.length}</p>
      ...
      <div className="bg-gray-900 rounded-lg shadow p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-2xl font-bold text-gray-200">{appointments.length}</p>
      ...
      <div className="bg-gray-900 rounded-lg shadow p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-2xl font-bold text-gray-200">24/7</p>
